...
const CSP_WEB = [
  ...
  "connect-src 'self' wss://voice.gachandra.ru https://integrations.livekit.io",
  "font-src 'self' data:",
...
const CSP_DESKTOP = [
  ...
  "style-src 'self' 'unsafe-inline'",
  "img-src 'self' data: blob: https:",
  "connect-src https://gachandra.ru wss://voice.gachandra.ru https://integrations.livekit.io",
  "font-src 'self' data:",
  "worker-src 'self' blob:",
  "object-src 'none'",
  "base-uri 'self'",
